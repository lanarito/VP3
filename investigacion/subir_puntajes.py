...
TELEGRAM_TOKEN = "PONDRE_EL_TOKEN_AQUI"
TELEGRAM_CHAT_ID = "PONDRE_EL_CHAT_ID_AQUI"
...
def procesar_y_subir():
    ...
    base_records = {"baselined_tables": [], "signatures": []}
        ...
        try:
            with open("base_records.json", "r") as f:
                ...
                if isinstance(data, list):
                    ...
                    # Extraer de las firmas solo las mesas que realmente tienen firmas registradas
    ...
    try:
        ...
        mapa_final = {d["ID_Record"]: d for d in nuevos_puntajes_filtrados}
        if existentes:
            for r in existentes:
